...
See the [latest version](./200427.pdf).
...
<!-- In the early stage, there is only one type of agents and one type of interactions. -->
...
There are three angles to this multi-agent system, which are illustrated using the following figure.
...
Essential terminologies from the above literature are illustrated using the following figure. There are some highlights:
